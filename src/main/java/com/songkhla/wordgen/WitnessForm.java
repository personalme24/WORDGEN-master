  ...
  FullNamePerson.addCaretListener(new TextFieldCaretListener());
     jComboBoxListName.addActionListener(new ComboBoxActionListener());
        String[] ItemDead = {"","พยาน","บิดาผู้ตาย", "มารดาผู้ตาย", "บุตรผู้ตาย", "สามีผูตาย", "ภรรยาผู้ตาย", "ผู้ปกครองผู้ตาย", "พี่ร่วมบิดามารดาของผู้ตาย",
           ...
           String[] ItemWitness = {"","ผู้ได้รับความเสียหายจากการกระทำของผู้ต้องหา","ผู้ร่วมจับกุมผู้ต้องหาและยึดของกลาง","ผู้พบการกระทำผิด","ผู้เสียหาย", "พยาน", "ผู้แจ้ง", "ญาติ", "บิดาผู้ต้องหา", "มารดาผู้ต้องหา","ผู้ปกครองหรือผู้ดูแลผู้ต้องหา","เจ้าหน้าที่สืบสวน"
...
//       --------------------------------Right Click----------------------------------------------------
    ...
    private void initComponents() {
        ...
        Related.setFont(new java.awt.Font("TH SarabunPSK", 0, 22)); // NOI18N
