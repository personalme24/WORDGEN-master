 ...
 * @author Computer
 */
public class CrimeBookOverview extends javax.swing.JDialog {
...
//        jButton1.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrimeBookOverview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrimeBookOverview().setVisible(true);
            }
        });
    }
 public void RefreshData(){
        ...
        String sql = "Select noperson,\n" +
                        ...
                        "where CrimeCase.CaseType='คดีอาญา'\n"+
