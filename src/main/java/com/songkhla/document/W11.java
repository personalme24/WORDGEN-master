...
public class W11 {
	public static void w11(String cc) {
            ...
            String PoliceStationName="";
             ...
             String Position ="";
             /*
             String EvidenceRecordNumber="";
             String OrderAsset= "";
             String Name = "";
             String Amount="";
             String Value="";
             String OccupantName="";
             String DateSequester="";
             String Remark="";
               */      
            try {
...
//              
		...
		try {
			...
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์/แบบฟอร์มสำนวน/บัญชีทรัพย์ของกลางคดีอาญา.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
   ...
   private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W11.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
    }
