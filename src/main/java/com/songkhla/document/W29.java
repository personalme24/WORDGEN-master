...
public class W29 {
    public static void w29(String cc) {
...
//                 bookmarkvalue.put("S27","-");
		...
		try {
			...
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์/แบบฟอร์มสำนวน/บันทึกการชี้ตัวผู้ต้องหา.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
