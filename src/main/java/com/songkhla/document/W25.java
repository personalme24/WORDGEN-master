 ...
 */
public class W25 {
    public static void w25(String cc) {
...
*/
                        ...
                        bookmarkvalue.put("P013", Checknull(s.getString("InvestPosition"))); //ตำแหน่งเต็ม
                            ...
                            bookmarkvalue.put("C411", ReplaceCollon(s.getString("OccuredTime")));
                            bookmarkvalue.put("C5", Checknull(ToDate(s.getString("CaseAcceptDate"))));
                            bookmarkvalue.put("C511", ReplaceCollon(s.getString("CaseAccepTime")));
...
//              
    ...
    private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W25.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
    }
