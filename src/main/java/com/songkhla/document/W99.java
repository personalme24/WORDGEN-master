...
public class W99 {
     public static void w99(String cc) {
...
//               
                  ...
                  while (rs1.next()) {                    
                   ...
                   String sql="select crimecase.*,ChargeCase.*,P1.*,P2.*,InvestInformation.*,ActionsCaseData.*\n" +
                            ...
                            + "Person.HouseNumber AccuredHouseNumber,Person.Moo AccuredMoo,Person.Tambon AccuredTambon,Person.Amphur AccuredAmphur,Person.Province AccuredProvince"
                            + " FROM Person where Person.TypePerson='ผู้กล่าวหา'\n" +
                              ...
                              "inner join(\n" +
                                ...
                                "Person.Nationality suspectNati,Person.HouseNumber suspectHouseNumber,Person.Moo suspectMoo,Person.Tambon suspectTambon,Person.Amphur suspectAmphur,Person.Province suspectProvince"
...
//              
		...
		bookmarkvalue.put("C2",Checknull(cs));
                ...
                bookmarkvalue.put("STATUS",Checknull(STATUS));
                 ...
                 bookmarkvalue.put("PA22", Checknull(s.getString("AccuredHouseNumber"))); 
                 bookmarkvalue.put("PA23", Checknull(s.getString("AccuredMoo"))); 
                 bookmarkvalue.put("PA24", Checknull(s.getString("AccuredTambon"))); 
                 bookmarkvalue.put("PA25", Checknull(s.getString("AccuredAmphur"))); 
                 bookmarkvalue.put("PA26", Checknull(s.getString("AccuredProvince"))); 
...
//			table1.add(repl2);
		...
		try {
			...
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์"+"/"+PoliceStationName+"/ปี"+ccYear+"/"+casetype+"/"+casetype+cs+"-"+ccYear+"/รายงานเหตุอุกฉกรรจ์และสะเทือนขวัญและเหตุที่ต้องรายงานด่วน" +cs+"-"+ccYear+".doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
...
//			table1.add(repl2);
    ...
    private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W99.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
}
