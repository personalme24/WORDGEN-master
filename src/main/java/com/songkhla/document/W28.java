...
public class W28 {
    public static void w28(String cc) {
...
//               
                  ...
                  while (rs1.next()) {                    
                   ...
                   String sql="select crimecase.*,ChargeCase.*,ActionsCaseData.*,Asset.*,P1.*,P2.*,InvestInformation.*\n" +
                      ...
                      /*
                       ...
                       bookmarkvalue.put("P03", Checknull(FirstName));
                        ...
                        bookmarkvalue.put("P013", Checknull(s.getString("InvestPosition"))); //ตำแหน่งเต็ม
                            ...
                            bookmarkvalue.put("C16", Checknull(s.getString("DocOrder")));
                            bookmarkvalue.put("C17", Checknull(s.getString("DocSlash")));
...
//			table1.add(repl2);
		...
		try {
			...
			WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage
					.load(new java.io.File("./TEMPLATE/w28.docx"));
			processVariable(bookmarkvalue,wordMLPackage);
			processTABLE(bookmarkvalue,wordMLPackage);
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์"+"/"+PoliceStationName+"/ปี"+ccYear+"/"+casetype+"/"+casetype+cs+"-"+ccYear+"/บันทึกการตรวจสภาพรถ" +cs+"-"+ccYear+".doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
...
//              
		...
		try {
			...
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์/แบบฟอร์มสำนวน/บันทึกการตรวจสภาพรถ.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
    ...
    private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W28.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
    }
