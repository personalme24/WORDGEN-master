...
public class W31 {
     public static void w31(String cc) {
...
//			table1.add(repl2);
      ...
      public static void nw31() {
		...
		try {
			...
			wordMLPackage.save(new java.io.File("./สำนวนอิเล็กทรอนิกส์/แบบฟอร์มสำนวน/บันทึกการจับกุม.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
	...
	private static void replaceTable(JSONArray placeholders, JSONArray data,
        ...
        private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W31.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
    }
