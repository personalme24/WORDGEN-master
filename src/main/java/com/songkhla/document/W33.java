...
public class W33 {
     public static void w33(String cc) {
...
//               
                  ...
                  while (rs1.next()) {                    
                   ...
                   String sql="select crimecase.*,ChargeCase.*,Person.ArrestDate,Person.PlaceArrest,Person.ArrestDateTime,InvestInformation.* \n" +
                               "from crimecase \n" +
...
//                System.out.print(" - ");
    ...
    private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(W33.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
    }
